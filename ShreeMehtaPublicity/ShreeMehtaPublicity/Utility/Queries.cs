...
namespace ShreeMehtaPublicity.Utility
{
    public class Queries
    {
        ...
        public string getAllSites = "SELECT SITE_SEQ, SITE_NAME, SITE_STATUS, SITE_ADDRESS, SITE_HEIGHT, SITE_WIDTH, SITE_AMOUNT, SITE_IMAGE FROM SITE_MASTER ORDER BY SITE_SEQ";
        public string getAllClients = "SELECT CLIENT_SEQ, CLIENT_NAME, CLIENT_STATUS, CLIENT_LANDLINE, CLIENT_MOBILE, CLIENT_MAIL, CLIENT_GST, CLIENT_ADDRESS, CLIENT_BRANCH FROM CLIENT_MASTER ORDER BY CLIENT_SEQ";
        ...
        public string getClientList = "SELECT CLIENT_SEQ, CLIENT_NAME, CLIENT_STATUS, CLIENT_LANDLINE, CLIENT_MOBILE, CLIENT_MAIL, CLIENT_GST, CLIENT_ADDRESS, CLIENT_BRANCH FROM CLIENT_MASTER WHERE (CLIENT_STATUS = '?' OR '?' = 'ALL') AND (lower(CLIENT_NAME) like '%?%' OR '?' = 'ALL') ORDER BY CLIENT_SEQ";
        ...
        public string getContactPersonList = "SELECT SEQ_NUM, CLIENT_SEQ_NUM, CONTACT_PERSON_NAME, CONTACT_PERSON_MOBILE, CONTACT_PERSON_MAIL FROM CONTACT_PERSON WHERE CLIENT_SEQ_NUM = ? ORDER BY CONTACT_PERSON_NAME";
        ...
        public string deleteOldCautationClient = "DELETE FROM CAUTATION_CLIENT WHERE CAUTATION_SEQ_NO = ?";
        public string getCautationDetails = "SELECT CAUTATION_SEQ_NO, SUBJECT, BODY, CAUTATION_FILE, CAUTATION_SEND_FLAG FROM CAUTATION_MASTER WHERE CAUTATION_SEQ_NO = ? ORDER BY CAUTATION_SEQ_NO";
